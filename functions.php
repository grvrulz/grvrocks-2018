<?php
/**
 * Grvrocks 2018 functions and definitions
 *
...
if ( ! function_exists( 'grvrocks_2018_setup' ) ) :
	/**
	...
	function grvrocks_2018_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'grvrocks-2018' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'grvrocks_2018_custom_background_args', array(
...
add_action( 'after_setup_theme', 'grvrocks_2018_setup' );
...
function grvrocks_2018_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'grvrocks_2018_content_width', 990 );
}
 ...
 */
function grvrocks_2018_scripts() {
	wp_enqueue_style( 'grvrocks-2018-style', get_stylesheet_uri() );

	wp_enqueue_script( 'grvrocks-2018-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'grvrocks-2018-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
